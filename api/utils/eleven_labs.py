...
resumo_do_texto = """
Rodolfo, Entendo completamente sua preocupação com o orçamento e como é importante garantir que você 
esteja fazendo um investimento valioso para sua empresa. O que diferencia nosso software das outras 
opções disponíveis não é apenas a qualidade e a confiabilidade, mas também a forma como ele é projetado <break time="0.2s" />
"""

# Escolha sua voz
voz_escolhida = "Usmart_rodolfo"
